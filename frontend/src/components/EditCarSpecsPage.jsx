...
// З ключем для фокусу (в інпуті відразу відображаєтьс напис key: 11119999888):
...
//   const lastAdditionalKeyRef = useRef(null);
...
//       },
//     }));
//      // Зберігаємо ключ, який ми щойно додали
//   lastAdditionalKeyRef.current = newKey;
//   };

//   useEffect(() => {
//     if (lastAdditionalKeyRef.current) {
//       const input = document.getElementById(`input-${lastAdditionalKeyRef.current}`);
//       if (input) {
//         input.focus();
//       }
//       lastAdditionalKeyRef.current = null;
//     }
//   }, [specs?.additionalSpecs]);
